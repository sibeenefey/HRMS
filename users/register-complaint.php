...
$query=mysqli_query($bd, "insert into tblcomplaintss(userId,Category,ComplaintDate,Roomdetails,state,noc,Complaintdetails,Hostel,Fullname,Username,Time,Employeename) values('$uid','$Category','$ComplaintDate','$Roomdetails','$state','$noc','$Complaintdetials','$Hostel','$Fullname','$Username','$Time','$Employeename')");

$sql=mysqli_query($bd, "select complaintNumber from tblcomplaintss  order by complaintNumber desc limit 1");
...
<html lang="en">
  <head>
    ...
    <title>HRMS| User Register Complaint</title>
...
<select name="complaintype" class="form-control" required="">
                <option value=" Roan">Roan</option>   
                  ...
                  <option value="Lechwe">Lechwe</option>    
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Room Details</label>
<div class="col-sm-4">
